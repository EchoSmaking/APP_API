...
$sqll = "INSERT INTO cms_admin (password,mobilenum,realname,passwordid,friendname,friendnum,status,bankaddress,bankid) 
	VALUES ('$passwords',$mobilephone,'$realname',$passwordid,$friendname,$friendnum,'2',$bankaddress,$bankid)";
$retss = mysql_query($sqll, $connect);

$sql3 = "SELECT * FROM cms_admin WHERE mobilenum = '$mobilephone'";
$ret3 = mysql_query($sqll, $connect);
$sing3 = mysql_fetch_assoc($ret3);
$admin_id = $sing3['admin_id'];

$sqll2 = "INSERT INTO cms_admin (address,impaddress,admin_id) VALUES ('$address','1','$admin_id')";
$retss2 = mysql_query($sqll2, $connect);
